...
# EAM_CALC is imported from utils (loaded once at module level)
from utils import EAM_CALC
import copy
import random
from utils import *
import itertools
...
class MCSEnv(gym.Env):
    ...
    def __init__(self, 
        ...
        self.initial_atoms.set_calculator(EAM_CALC)  # EAM replaces EMT
    ...
    def save_traj(self):      
        ...
        for atoms in self.trajectories:
            atoms.set_calculator(EAM_CALC)  # EAM replaces EMT
    ...
    def reset(self):
        ...
        self.atoms.set_calculator(EAM_CALC)  # EAM replaces EMT

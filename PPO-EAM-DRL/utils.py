...
# ---------------------------------------------------------------------------
# EAM potential – loaded once at module level so the (potentially large)
# potential file is only read from disk once per process.
# Replace 'Pd_Zhou04.alloy' with the actual filename of your EAM potential.
# Common Pd potentials (Zhou 2004 / Sheng 2011) are available from:
#   https://www.ctcms.nist.gov/potentials/
# ---------------------------------------------------------------------------
EAM_CALC = EAM(potential='CuAgAuNiPdPtAlPbFeMoTaWMgCoTiZr_Zhou04.eam.alloy')
...
def fixOverlap(clus_to_fix):
    ...
    clus_to_fix_sorted.calc = EAM_CALC  # EAM replaces EMT
